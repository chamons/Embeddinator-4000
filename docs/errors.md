...
<h3><a name="EM0028"/>EM0028 Non-embedded macOS only supports the Library compilation option.</h3>

Non-embedded macOS only supports the Library compilation option `--target=library`
