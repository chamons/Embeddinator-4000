...
namespace DriverTest {
	...
	public class OptionsChecks {
		...
		public void EM0027 ()
		{
			...
			Asserts.ThrowsEmbeddinatorException (28, "Non-embedded macOS only supports the Library compilation option.", () => Driver.Main2 (new[] { "--target=static", $"--platform=macOS" }));
			Asserts.ThrowsEmbeddinatorException (28, "Non-embedded macOS only supports the Library compilation option.", () => Driver.Main2 (new[] { "--target=framework", $"--platform=macOS" }));
		}
	}
}